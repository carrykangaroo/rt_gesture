"""CLER (Classification Error Rate) computation for discrete gesture evaluation.

Internalized from generic_neuromotor_interface.cler to eliminate external dependency.
...
def get_matched_indices(
    ...
    -------
    list[tuple[int | None, int | None]]
        A list of tuples of indices defining the alignment.
    """
